...
export const ViperCar = React.memo(({ angle, speed }: { angle: number, speed: number }) => (
...
export const ChallengerCar = React.memo(({ angle, speed }: { angle: number, speed: number }) => (
    <CarContainer angle={angle} speed={speed}>
        <svg viewBox="0 0 100 200" className="w-full h-full" style={{filter: 'drop-shadow(2px 4px 6px black)'}}>
...
export const PorscheCar = React.memo(({ angle, speed }: { angle: number, speed: number }) => (
    <CarContainer angle={angle} speed={speed}>
        <svg viewBox="0 0 100 200" className="w-full h-full" style={{filter: 'drop-shadow(2px 4px 6px black)'}}>
...
export const LamboCar = React.memo(({ angle, speed }: { angle: number, speed: number }) => (
    <CarContainer angle={angle} speed={speed}>
        <svg viewBox="0 0 100 200" className="w-full h-full" style={{filter: 'drop-shadow(2px 4px 6px black)'}}>
