...
const CarContainer = ({ angle, speed, children }: { angle: number, speed: number, children: React.ReactNode }) => {
...
export const ViperCar = React.memo(({ angle, speed, color }: { angle: number, speed: number, color?: string }) => (
    <CarContainer angle={angle} speed={speed}>
...
export const ChallengerCar = React.memo(({ angle, speed, color }: { angle: number, speed: number, color?: string }) => (
    <CarContainer angle={angle} speed={speed}>
        <svg viewBox="0 0 100 200" className="w-full h-full" style={{filter: 'drop-shadow(2px 4px 6px black)'}}>
...
export const PorscheCar = React.memo(({ angle, speed, color }: { angle: number, speed: number, color?: string }) => (
    <CarContainer angle={angle} speed={speed}>
        <svg viewBox="0 0 100 200" className="w-full h-full" style={{filter: 'drop-shadow(2px 4px 6px black)'}}>
...
export const LamboCar = React.memo(({ angle, speed, color }: { angle: number, speed: number, color?: string }) => (
    <CarContainer angle={angle} speed={speed}>
        <svg viewBox="0 0 100 200" className="w-full h-full" style={{filter: 'drop-shadow(2px 4px 6px black)'}}>
